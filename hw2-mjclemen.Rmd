...
icons <- awesomeIconList(
  Day = makeAwesomeIcon(icon = "sun", library = "fa", markerColor = "orange"),
  Evening = makeAwesomeIcon(icon = "cloud-moon", library = "fa", markerColor = "purple"),
  Midnight = makeAwesomeIcon(icon = "moon", library = "fa", markerColor = "black")
)
