...
```{r}
color.by.census <- colorBin(palette = "Dark2", domain = crimes$CENSUS_TRACT, bins = 7)
...
```{r}
crime.district <- colorBin(palette = c("red", "blue", "purple", "black", "orange", "pink", "green"),
                           domain = crimes$CENSUS_TRACT, bins = 7)
